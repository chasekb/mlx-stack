...
from ai_dev.templates import AGENT_HTTP_API, AGENT_HTTP_SERVICE, AGENT_SERVER, EMBED_QUEUE_SERVER, EMBED_WORKER, RAG_SERVER, SPEC_ROUTER_SERVER

TEMPLATE_RUNTIME_PAIRS = {
    "AGENT_SERVER": (AGENT_SERVER, ROOT / "agent" / "server.py"),
    "AGENT_HTTP_API": (AGENT_HTTP_API, ROOT / "agent" / "http_api.py"),
    "AGENT_HTTP_SERVICE": (AGENT_HTTP_SERVICE, ROOT / "agent" / "http_service.py"),
